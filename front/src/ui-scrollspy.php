    ...
    <div class="page-wrapper">
        ...
        <div class="content pb-0">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Scroll the area below the navbar and watch the active class change. The dropdown items will be highlighted as well.</p>
                    ...
                    <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Scrollspy also works with nested <code>.nav</code>s. If a nested <code>.nav</code> is <code>.active</code>, its parents will also be <code>.active</code>. Scroll the area next to the navbar and watch the active class change.</p>
