                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <img src="assets/img/avatars/avatar-03.jpg" alt="image" class="img-fluid rounded-circle" width="133">
                                            <p class="mb-0">
                                        ...
                                        <div class="col-sm-3">
                                            <img src="assets/img/avatars/avatar-02.jpg" alt="image" class="img-thumbnail rounded-pill" width="133">
                                            <p class="mb-0">
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="rounded float-start" src="assets/img/media/img-1.jpg" alt="..." width="200">
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="rounded mx-auto d-block" src="assets/img/media/img-1.jpg" alt="..." width="200">
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="rounded float-end" src="assets/img/media/img-1.jpg" alt="..." width="200">
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body d-flex justify-content-between gap-2 pb-1">
                            <figure class="figure">
                                <img class="bd-placeholder-img figure-img img-fluid rounded card-img" src="assets/img/media/img-1.jpg" alt="...">
