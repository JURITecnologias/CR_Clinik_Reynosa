            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities <strong>do not set <code>color</code></strong>, so in some cases you’ll want to use <code>.text-*</code>color utilities.</p>
                            ...
                            <div class="bg-dark text-white p-2 mb-2">.bg-dark</div>
                ...
                <div class="col-xl-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted">By adding a <code>.bg-gradient</code> class, a linear gradient is added as background image to the backgrounds. This gradient starts with a semi-transparent white which fades out to the bottom.</p>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Color and background helpers combine the power of our <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our Sass <code>color-contrast()</code> function, we automatically determine a contrasting <code>color</code> for a particular <code>background-color</code>.</p>
                            <div class="d-flex flex-column gap-2">
                ...
                <div class="col-xl-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted fs-14">You can use the <code>.link-*</code> classes to colorize links. Unlike the <code>.text-*</code> classes, these classes have a <code>:hover</code> and <code>:focus</code> state.</p>
                            <div class="d-flex flex-column gap-2">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted"><code>background-color</code> utilities are generated with Sass using CSS variables. This allows for real-time color changes without compilation and dynamic alpha transparency changes.</p>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted">The <code>opacity</code> property sets the opacity level for an element. The opacity level describes the transparency level, where <code>1</code> is not transparent at all, <code>.5</code> is 50% visible, and <code>0</code> is completely transparent. Set the <code>opacity</code> of an element using <code>.opacity-{value}</code> utilities.</p>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use border utilities to <b>add</b> an element’s borders. Choose from all borders or one at a time.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use border utilities to <b>remove</b> an element’s borders. Choose from all borders or one at a time.</p>
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-2">
                                <img src="assets/img/avatars/avatar-39.jpg" class="avatar-lg rounded" alt="rounded">
                                <img src="assets/img/avatars/avatar-39.jpg" class="avatar-lg rounded-top" alt="rounded-top">
                                <img src="assets/img/avatars/avatar-39.jpg" class="avatar-lg rounded-end" alt="rounded-end">
                                <img src="assets/img/avatars/avatar-39.jpg" class="avatar-lg rounded-bottom" alt="rounded-bottom">
                                <img src="assets/img/avatars/avatar-39.jpg" class="avatar-lg rounded-start" alt="rounded-start">
                                <img src="assets/img/avatars/avatar-39.jpg" class="avatar-lg rounded-circle" alt="rounded-circle">
                                <img src="assets/img/avatars/avatar-37.jpg" class="avatar-lg w-auto rounded-pill" alt="rounded-pill">
                            </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-2">
                                <img src="assets/img/avatars/avatar-51.jpg" class="avatar-lg rounded-0" alt="rounded-0">
                                <img src="assets/img/avatars/avatar-51.jpg" class="avatar-lg rounded-1" alt="rounded-1">
                                <img src="assets/img/avatars/avatar-51.jpg" class="avatar-lg rounded-2" alt="rounded-2">
                                <img src="assets/img/avatars/avatar-51.jpg" class="avatar-lg rounded-3" alt="rounded-3">
                                <img src="assets/img/avatars/avatar-51.jpg" class="avatar-lg rounded-4" alt="rounded-4">
                                <img src="assets/img/avatars/avatar-51.jpg" class="avatar-lg rounded-5" alt="rounded-5">
                            </div>
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="pe-none mb-0"><a href="#" tabindex="-1">This link</a> can not be clicked because the <code>pointer-events</code> property is inherited from its parent. However, <a href="#" class="pe-auto">this link</a> has a <code>pe-auto</code> class and can be clicked.</p>
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Width utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify those values as you need to generate different utilities here.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Height utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify those values as you need to generate different utilities here.</p>
                            <div class="d-flex flex-wrap gap-2 align-items-start overflow-hidden" style="height: 255px;">
                                ...
                                <div class="h-auto p-2 bg-light">auto</div>
                            </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <p class="text-muted">Use <code>z-index</code> utilities to stack elements on top of one another. Requires a <code>position</code> value other than <code>static</code>, which can be set with custom styles or using our position utilities.</p>
