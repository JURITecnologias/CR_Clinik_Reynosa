    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                ...
                <a href="manage-invoices-details.php" class="btn btn-primary"><i class="ti ti-eye me-1"></i>Preview</a>
            </div>
            <!-- End Page Header -->   
            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <form action="manage-edit-invoices.php">
                                            ...
                                            <td>
                                                <div class="custom-increment cart">
                                                    <div class="position-relative">
                                                        ...
                                                        <input type="text" id="quantity1" name="quantity1" class="form-control text-center" value="10" style="width: 110px;">
                                                        <div class="position-absolute end-0 top-50 translate-middle-y">
