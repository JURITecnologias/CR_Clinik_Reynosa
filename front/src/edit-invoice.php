    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                ...
                <a href="invoice-details.php" class="btn btn-primary"><i class="ti ti-eye me-1"></i>Preview</a>
            </div>
            <!-- End Page Header -->   
                ...
                <div class="card-body">
                    ...
                    <form action="edit-invoice.php">
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" value="78.21">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3 border-top pt-3 mt-3">
                            <a href="invoice-details.php" class="btn btn-dark"><i class="ti ti-eye me-1"></i>Preview</a>
