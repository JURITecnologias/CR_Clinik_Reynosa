    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <!-- tabs start -->
                ...
                <li class="nav-item">
                    <a href="patient-details-vital-signs.php" class="nav-link border rounded fw-semibold active">
                        Vital Signs
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="card mb-0">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-nowrap">
                        <?php 
                            $jsonContent = file_get_contents('../assets/json/patient-details-vital-signs.json');
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 mb-0 fw-medium"><a href="doctor-details.php"><?= $vital['doctor_name'] ?></a></h6>
                                                </div>
                                            </div>
                                        </td>
