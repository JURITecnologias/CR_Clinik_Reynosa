                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="avatar-list-stacked avatar-group-lg mb-3">
                                <span class="avatar">
                                    <img class="border border-white" src="assets/img/avatars/avatar-04.jpg" alt="avatar">
                                </span>
                                <span class="avatar">
                                    <img class="border border-white" src="assets/img/avatars/avatar-04.jpg" alt="avatar">
                                </span>
                        ...
                        <div class="card-body">
                            <div class="avatar-list-stacked avatar-group-lg mb-3">
                                <span class="avatar avatar-rounded">
                                    <img class="border border-white" src="assets/img/avatars/avatar-05.jpg" alt="avatar">
                                </span>
                                <span class="avatar avatar-rounded">
                                    <img class="border border-white" src="assets/img/avatars/avatar-05.jpg" alt="avatar">
                                </span>
