                ...
                <div class="col-xl-12">					
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="#">
                                <div class="mb-3 row">
                                    <label class="form-label col-lg-2">Group Left</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="row">
                                    <label class="form-label col-lg-2">With textarea</label>
                                    <div class="col-lg-10">
                                        <div class="input-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <form action="#">
                                <div class="mb-3 row">
                                    <label class="form-label col-lg-2">Input Group Large</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="mb-3 row">
                                    <label class="form-label col-lg-2">Input Group Default</label>
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                ...
                                <div class="mb-3 row">
                                    <label class="form-label col-lg-2">Input Group Small</label>
                                    <div class="col-lg-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="#">
                                <div class="mb-3 row">
                                    <label class="form-label col-lg-2">Checkbox</label>
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                ...
                                <div class="row">
                                    <label class="form-label col-lg-2">Radio</label>
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="#">
                                ...
                                <div class="row">
                                    <label class="form-label col-lg-2">Two Addons Right</label>
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <input type="text" class="form-control">
                                            <span class="input-group-text">$</span>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Segmented Buttons</h5>
                        </div>
                        <div class="card-body">
                            <div class="input-group mb-3">
