                    ...
                    <div class="row g-0">
                        <div class="col-lg-3 col-sm-4 d-flex">
                            <div class="border-end p-4 flex-fill">
                                <div>
                                    <div class="mb-3">
                                        <a href="#" class="btn btn-primary btn-lg w-100" data-bs-toggle="modal" data-bs-target="#add_todo"><i class="ti ti-square-rounded-plus me-1"></i>Add Task</a>
                                    </div>
                        ...
                        <div class="col-lg-9 col-sm-8 d-flex">
                            <!-- card start -->
                            <div class="card m-sm-4 mx-4 w-100">
