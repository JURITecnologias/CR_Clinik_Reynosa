    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <!-- tabs start -->
                ...
                <li class="nav-item">
                    <a href="patient-details-lab-results.php" class="nav-link border rounded fw-semibold active">
                        Lab Results
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="card mb-0">
                ...
                <div class="card-header d-flex align-items-center flex-wrap gap-2 justify-content-between">
                    <h5 class="d-inline-flex align-items-center mb-0">Total Lab Results <span class="badge bg-danger ms-2">658</span></h5>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-nowrap">
                        <?php 
                            $jsonContent = file_get_contents('../assets/json/patient-details-lab-results.json');
                        ...
                        <table class="table mb-0 border">
                            ...
                            <tbody>
                                <?php foreach ($data as $result): ?>
                                    <tr>
                                        <td><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#view_modal"><?= $result['test_id'] ?></a></td> 
                                        <td><?= $result['appointment_date'] ?></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="doctor-details.php" class="avatar avatar-xs me-2">
                                                    <img src="<?= $result['doctor_avatar'] ?>" alt="doctor" class="rounded">
                                                </a>
                                                <div>
                                                    <h6 class="fs-14 mb-0 fw-medium"><a href="doctor-details.php"><?= $result['doctor_name'] ?></a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge badge-soft-<?= $color ?>"><?= $result['status'] ?></span>
                                        </td>
                                        <td class="text-end">
