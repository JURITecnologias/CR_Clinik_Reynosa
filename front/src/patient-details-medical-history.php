    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs nav-item-primary border-bottom pb-4 mb-4 d-flex align-items-center gap-2">
                ...
                <li class="nav-item">
                    <a href="patient-details-medical-history.php" class="nav-link border rounded fw-semibold active">
                        Medical History
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="card mb-0">
                ...
                <div class="card-header d-flex align-items-center flex-wrap gap-2 justify-content-between">
                    <h5 class="d-inline-flex align-items-center mb-0">Medical History<span class="badge bg-danger ms-2">658</span></h5>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-nowrap">
                        <?php 
                            $jsonContent = file_get_contents('../assets/json/patient-details-medical-history.json');
                        ...
                        <table class="table mb-0 border">
                            <thead class="table-light">
                                <tr>
                                    <th class="no-sort">Illness Name</th>
                                    <th>Illness Date</th>
                                    <th class="no-sort"></th>
                                </tr>
                            </thead>
