                            ...
                            <div class="row" data-plugin="dragula" data-containers='["company-list-left", "company-list-right"]'>
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light bg-opacity-50 p-2 p-lg-4">
                                        ...
                                        <div id="company-list-left" class="pt-2">

                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start">
                                                        <img src="assets/img/avatars/avatar-01.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start">
                                                        <img src="assets/img/avatars/avatar-02.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start">
                                                        <img src="assets/img/avatars/avatar-03.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light bg-opacity-50 p-2 p-lg-4">
                                        ...
                                        <div id="company-list-right" class="pt-2">
                                            <div class="card mb-0 mt-2">

                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-start">
                                                        <img src="assets/img/avatars/avatar-04.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-start">
                                                        <img src="assets/img/avatars/avatar-05.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-start">
                                                        <img src="assets/img/avatars/avatar-06.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="bg-light bg-opacity-50 p-2 p-lg-4">
                                        ...
                                        <div id="handle-dragula-left" class="pt-2">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/img/avatars/avatar-07.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/img/avatars/avatar-08.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                            ...
                                            <div class="card mb-0 mt-2">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/img/avatars/avatar-09.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="bg-light bg-opacity-50 p-2 p-lg-4">
                                        ...
                                        <div id="handle-dragula-right" class="pt-2">
                                            <div class="card mb-0 mt-2">
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/img/avatars/avatar-10.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                        <div class="w-100 overflow-hidden">
