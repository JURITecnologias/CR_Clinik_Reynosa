        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                ...
                <div class="gap-2 d-flex align-items-center flex-wrap">
                    ...
                    <a href="add-invoice.php" class="btn btn-primary"><i class="ti ti-square-rounded-plus me-1"></i>New Invoice</a>
                </div>
            </div>
            <!-- End Page Header -->   
            ...
            <div class="card mb-0">
                ...
                <!-- table start -->
                    <div class="table-responsive table-nowrap">
                        <?php 
                            $jsonContent = file_get_contents('../assets/json/invoice.json');
                        ...
                        <table class="table border">
                            ...
                            <tbody>
                                <?php foreach ($data as $invoice): ?>
                                    <tr>
                                        <td><a href="invoice-details.php">#<?= $invoice['invoice'] ?></a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-sm me-2"><img src="<?= $invoice['avatar'] ?>" alt="patient"></a>
                                                <h6 class="mb-0 fs-14 fw-medium"><a href="#"><?= $invoice['name'] ?></a></h6>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge badge-soft-<?= $color ?>"><?= $invoice['status'] ?></span>
                                        </td>
                                        <td class="text-end">
                                            <div>
                                                ...
                                                <ul class="dropdown-menu p-2">
                                                    <li>
                                                        <a href="invoice-details.php" class="dropdown-item d-flex align-items-center"><i class="ti ti-eye me-1"></i>Preview</a>
                                                    </li>  
                                                    <li>
                                                        <a href="edit-invoice.php" class="dropdown-item d-flex align-items-center"><i class="ti ti-edit me-1"></i>Edit</a>
                                                    </li>                                       
                                                    <li>
