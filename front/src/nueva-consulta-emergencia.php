...
<div class="page-wrapper">
    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
            <div class="breadcrumb-arrow">
                <h4 class="mb-1">Consulta de Emergencia</h4>
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Consulta de Emergencia</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="p-3 bg-light rounded">
                            <div class="row row-gap-2">
                                ...
                                <div class="col-6 col-md-4">
                                    <h6 class="mb-1">Fecha de Consulta</h6>
        ...
        <input type="hidden" id="frm_diagnostico" value="">
        <div class="d-none" id="invalid_frm_diagnostico"></div>
        <input type="hidden" id="frm_medicamento_nombre" value="">
        <input type="hidden" id="frm_medicamento_dosis" value="">
        <input type="hidden" id="frm_medicamento_duracion" value="">
        ...
        <div class="d-flex justify-content-end flex-wrap align-items-center gap-2 mt-3">
            ...
            <input type="hidden" id="receta" value="">
            <button onclick="GuardarConsulta()" class="btn btn-primary btn-lg btn-save">Guardar Datos de Consulta</button>
            <button onclick="CerrarConsulta()" class="btn btn-warning btn-lg d-none" id="btn_cerrar_consulta">Cerrar Consulta</button>
        </div>
    ...
    <script>
        window.searchCitaByConsulta = window.searchCitaByConsulta || searchCitaByConsulta;
        window.getRecetaByConsultaId = window.getRecetaByConsultaId || getRecetaByConsultaId;
        window.LoadConsulta = window.LoadConsulta || LoadConsulta;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (inputServiciosMedicos && typeof Awesomplete === 'function') {
                ...
                inputServiciosMedicos.addEventListener('input', async function() {
                    ...
                    if (result) {
                        result.forEach(s => {
                            const categoria = s.categoria || 'Sin categoria';
                            s.displayName = s.nombre.charAt(0).toUpperCase() + s.nombre.slice(1) + ' - ' + categoria.charAt(0).toUpperCase() + categoria.slice(1);
                        });
                        inputServiciosMedicos._serviciosmedicos = result;
                        awesompleteServiciosMedicos.list = result.map(s => s.displayName);
                    }
                });

                inputServiciosMedicos.addEventListener('awesomplete-selectcomplete', function() {
                    const selectedName = inputServiciosMedicos.value;
                    const serviciosMedicos = inputServiciosMedicos._serviciosmedicos || [];
                    const serv = serviciosMedicos.find(s => s.displayName === selectedName);
        ...
        function loadEvent() {
            ...
            if (typeof window.LoadConsulta === 'function') {
                window.LoadConsulta(p);
            } else {
                console.error('LoadConsulta no está disponible en la página de emergencia.');
            }
        }
    </script>
