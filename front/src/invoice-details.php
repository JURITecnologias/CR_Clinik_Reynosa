            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                        <h6 class="mb-0"><a href="invoice.php"><i class="ti ti-arrow-left me-2"></i>Invoice</a></h6>
                        <div class="d-flex align-items-center ">
                            <button class="btn btn-white me-2" type="button"><i class="ti ti-file-download me-1"></i>Download PDF</button>
                            <button class="btn btn-white" type="button"><i class="ti ti-printer me-1"></i>Print</button>
                        </div>
                    </div>
                    <!-- End Page Header -->   
                            ...
                            <div class="bg-light rounded p-3 mb-3">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="invoice-logo">
                                        <img src="assets/img/logo-dark.svg" class="logo-white" alt="logo">
                                ...
                                <div class="row align-items-center gy-4">
                                    <div class="col-lg-5">
                                        <div>
                                            ...
                                            <p class="mb-1 text-body">15 Hodges Mews, High Wycombe HP12 3JL, <br> United Kingdom</p>
                                            <p class="mb-0 text-body">Phone : +1 45659 96566</p>
                                        </div>
                                    </div> <!-- end col -->
                                    ...
                                    <div class="col-lg-5">
                                        <div>
                                            ...
                                            <p class="mb-1 text-body">1147 Rohan Drive Suite, Burlington, VT / 8202115 <br> United Kingdom</p>
                                            <p class="mb-0 text-body">Phone : +1 36254 56589</p>
                                        </div>
                                    </div> <!-- end col -->

                                    <div class="col-lg-2">
                                        <div class="text-end">
                                            <div><img src="assets/img/icons/qr-code.svg" alt="qr-code" class="img-fluid"></div>
                                        </div>
                                    </div> <!-- end col -->
                                ...
                                <div class="col-xl-7">
                                    <div class="mb-3">
                                        ...
                                        <div class="bg-soft-info text-info rounded mt-3 p-3">
                                            <p class="mb-0"><span class="fw-semibold">Note :</span> Payment for all accounts is due within 7 days from the date of invoice receipt. Payments can be made via cheque, credit card, or direct online payment. Failure to settle the account within 7 days will result in the agreed quoted fee,</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5">
