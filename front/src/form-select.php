                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted">Select2 gives you a customizable select box with support for searching, tagging, remote data sets, infinite scrolling, and many other highly used options.</p>
                            <div class="row g-3">
                                <div class="col-lg-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                ...
                                <div>
                                    ...
                                    <input class="form-control" id="choices-text-disabled" data-choices data-choices-text-disabled-true type="text" value="alex@example.com, laura@example.com">
                                </div>
