            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-3 theiaStickySidebar">
                            <div class="border-end p-4">
                                <div class="p-0">
                                    <div class="border shadow rounded p-3 mb-3 position-relative">
                                    ...
                                    <div class="mb-3">
                                        <a href="javascript:void(0);" class="btn btn-primary d-inline-flex align-items-center justify-content-center w-100"><i class="ti ti-square-rounded-plus me-2"></i>Create Post</a>
                                    </div>
                                    <div class="files-list border-bottom pb-2 mb-3">
                                        <a href="javascript:void(0);" class="d-flex align-items-center justify-content-between active fw-medium p-2">
                                            <span><i class="ti ti-brand-feedly me-2"></i>All Feeds</span>
                                            <span class="badge bg-danger badge-xs rounded-pill">56</span>
                                        </a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-mood-search me-2"></i>Explore</a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-mail-check me-2"></i>Messages</a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-list me-2"></i>Lists</a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-bookmark me-2"></i>Bookmark</a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-coffee me-2"></i>Marketplace</a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-file-text me-2"></i>Files</a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-music me-2"></i>Media</a>
                                        <a href="javascript:void(0);" class="d-flex align-items-center fw-medium p-2"><i class="ti ti-user-share me-2"></i>Profile</a>
                                    </div>
                                    <div>
                                        <div class="mb-2">
                                            <h6 class="fs-16">Pages You Liked</h6>
                                        </div>
                                        <div>
                                            <a href="javascript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                                ...
                                                <span class="btn btn-light btn-icon"><i class="ti ti-thumb-down"></i></span>
                                            </a>
                                            <a href="javascript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                                <span class="d-inline-flex align-items-center">
                        ...
                        <div class="col-xxl-6 col-xl-6">
                            <div class="pt-xl-4 mx-4 mx-xl-0">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="social-feed.php">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                                <div class="d-flex align-items-center flex-wrap gap-2">
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Photo" data-bs-original-title="Photo"><i class="ti ti-photo fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Link" data-bs-original-title="Link"><i class="ti ti-link fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Paperclip" data-bs-original-title="Paperclip"><i class="ti ti-paperclip fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Video" data-bs-original-title="Video"><i class="ti ti-video fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Hash" data-bs-original-title="Hash"><i class="ti ti-hash fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Map" data-bs-original-title="Map"><i class="ti ti-map-pin-heart fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Smile" data-bs-original-title="Smile"><i class="ti ti-mood-smile fs-16"></i></a>
                                                </div>
                                                <div class="d-flex align-items-center flex-wrap gap-2">
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh" data-bs-original-title="Refresh"><i class="ti ti-refresh fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Trash" data-bs-original-title="Trash"><i class="ti ti-trash fs-16"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-light"  data-bs-toggle="tooltip" data-bs-placement="top" aria-label="World" data-bs-original-title="World"><i class="ti ti-world fs-16"></i></a>
                                                    <button type="submit" class="btn btn-primary d-inline-flex align-items-center"><i class="ti ti-square-rounded-plus fs-16 me-2"></i>Share Post</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div><!-- end card body -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-3">
                                            <h5 class="mb-0">Popular Channels</h5>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                ...
                                <div class="card">
                                    <div class="card-header border-0 pb-0">
                                        <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                            <div class="d-flex align-items-center flex-wrap">
                                                <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="assets/img/avatars/avatar-03.jpg" alt="user"></a>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <p class="mb-0 text-dark me-3">About 1 hr ago</p>
                                                <div class="dropdown">
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-outline-light" data-bs-toggle="dropdown" aria-expanded="true">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="btn btn-icon btn-outline-light border-0 btn-sm"><i class="ti ti-heart-filled text-danger"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-outline-light border-0 btn-sm"><i class="ti ti-share"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-outline-light border-0 btn-sm"><i class="ti ti-message-star"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-outline-light border-0 btn-sm"><i class="ti ti-bookmark-filled text-warning"></i></a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-start">
                                            <a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="assets/img/avatars/avatar-04.jpg" alt="user"></a>
                                ...
                                <div class="card">
                                    <div class="card-header border-0 pb-0">
                                        <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                            <div class="d-flex align-items-center flex-wrap">
                                                <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="assets/img/avatars/avatar-05.jpg" alt="user"></a>
                                                <div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-2">
                                            ...
                                            "Believe in yourself and all that you are. Know that there is something inside you that is greater than any obstacle.
                                                <a href="javascript:void(0);" class="link-info">#MotivationMonday </a>
                                                <a href="javascript:void(0);" class="link-info"> #Inspiration</a>
                                                🌟"
                                            </p>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header border-0 pb-0">
                                        <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                            <div class="d-flex align-items-center flex-wrap">
                                                <span class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="assets/img/avatars/avatar-04.jpg" alt="user"></span>
                                                <div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-2">
                                            <p class="text-dark fw-medium">
                                                ...
                                                <a href="javascript:void(0);" class="link-info">#NewRelease </a>
                                                <a href="javascript:void(0);" class="link-info">  #Innovation</a> 🎉
                                            </p>
                                        </div>
                                        <div class="card shadow-none mb-3">
                                            <div class="card-img card-img-hover rounded-0">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-light border-0"><i class="ti ti-heart-filled text-danger"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-light border-0"><i class="ti ti-share"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-light border-0"><i class="ti ti-message-star"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-light border-0"><i class="ti ti-bookmark-filled text-warning"></i></a>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-start mb-3">
                                            ...
                                            <div class="bg-light rounded flex-fill p-2">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h6 class="fs-16 mb-0"><a href="javascript:void(0);">Frank Hoffman</a></h6>
                                        ...
                                        <div class="d-flex align-items-start mb-3 ms-4 ps-2">
                                            ...
                                            <div class="bg-light rounded flex-fill p-2">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h6 class="fs-16 mb-0"><a href="javascript:void(0);">Sophie Headrick</a></h6>
                                                    <span class="ms-2">12:45 PM</span>
                                                </div>
                                                <p class="mb-1">
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            ...
                                            <div class="bg-light rounded flex-fill p-2">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h6 class="fs-16 mb-0"><a href="javascript:void(0);">Samuel Butler</a></h6>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <span class="avatar avatar-rounded me-2 flex-shrink-0"><img src="assets/img/avatars/avatar-05.jpg" alt="user"></span>
                                            <input type="text" class="form-control" placeholder="Enter Comments">
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                        ...
                        <div class="col-xxl-3 col-xl-3 theiaStickySidebar">
                            <div class="ps-4 ps-xl-0 pe-4 mt-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-light btn-icon"><i class="ti ti-user-x"></i></a>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);" class="btn btn-outline-light text-dark w-100">View All <i class="ti ti-arrow-right ms-2"></i></a>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                            <a href="javascript:void(0);" class="link-info d-inline-flex">#HealthTips</a>
                                            <a href="javascript:void(0);" class="link-info d-inline-flex">#Wellness</a>
                                            <a href="javascript:void(0);" class="link-info d-inline-flex">#Motivation</a>
                                            <a href="javascript:void(0);" class="link-info d-inline-flex">#Inspiration </a>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3">
                                            <a href="javascript:void(0);" class="btn btn-outline-light text-dark w-100">Upgrade Now <i class="ti ti-arrow-right ms-2"></i></a>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div>
