    ...
    <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <ul class="nav nav-tabs nav-item-primary border-bottom pb-4 mb-4 d-flex align-items-center gap-2">
                    ...
                    <li class="nav-item">
                        <a href="patient-details-visit-history.php" class="nav-link border rounded fw-semibold active">
                           Visit History
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card-body">
                       <!-- table start -->
                        <div class="table-responsive table-nowrap">
                            <?php 
                                $jsonContent = file_get_contents('../assets/json/patient-details-visit-history.json');
                            ...
                            <table class="table mb-0 border">
                                ...
                                <tbody>
                                    <?php foreach ($data as $visit): ?>
                                        <tr>
                                            <td><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#view_modal"><?= $visit['patient_id'] ?></a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="doctor-details.php" class="avatar avatar-xs me-2">
                                                        <img src="<?= $visit['doctor_avatar'] ?>" alt="doctor" class="rounded">
                                                    </a>
                                                    <div>
                                                        <h6 class="fs-14 mb-0 fw-medium"><a href="doctor-details.php"><?= $visit['doctor_name'] ?></a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><?= $visit['department'] ?></td>                                        
                                            <td><?= $visit['appointment'] ?></td>
                                            <td>
                                            <?php 
                                                $status = $visit['status'];
                                                $colorMap = [
                                            ...
                                            ?>
                                            <span class="badge badge-soft-<?= $color ?>"><?= $visit['status'] ?>
                                            </span>
                                            </td>
                                            <td class="text-end">
