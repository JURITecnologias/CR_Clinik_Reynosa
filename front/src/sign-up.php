                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="row justify-content-center align-items-center overflow-auto flex-wrap vh-100">
                            <div class="col-md-8 mx-auto">
                                <form action="login.php" class="d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-lg-center flex-fill">
                                        <div class="card border-1 p-lg-3 shadow-md rounded-3 m-0">
                                            <div class="card-body">
                                                ...
                                                <div class="mb-2">
                                                    <button type="submit" class="btn bg-primary text-white w-100">Create account</button>
                                                </div>
                                                ...
                                                <div class="text-center">
                                                    <h6 class="fw-normal fs-14 text-dark mb-0">Don’t have an account yet?
                                                        <a href="login.php" class="ms-1 text-primary">Sign In</a>
                                                    </h6>
                                                </div>
                                            </div><!-- end card body -->
                                        </div><!-- end card -->
